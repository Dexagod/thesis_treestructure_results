...
for dataset in datasets:
  ...
  if dataset == "stops":
    datasetname = "transport stops (query log)"
  if dataset == "randomstops":
    datasetname = "transport stops (randomized)"
  if dataset == "realistic":
    datasetname = "OSMnames (randomized)"
  ...
  plt.gcf().suptitle('Average query results in 150ms over subsequent queries in a series | ' + datasetname + "                     ")
